...
export default class customExporter {
    ...
    constructor(apiConfig, exportConfig, logger, accessToken) {
        ...
        this.client = (0, _sdkClient.createClient)({
            middlewares: [(0, _sdkMiddlewareAuth.createAuthMiddlewareForClientCredentialsFlow)({...this.apiConfig,
    ...
    static _buildProductProjectionsUri(projectKey, exportConfig) {
            ...
            if ((_exportConfig$expand = exportConfig.expand) === null || _exportConfig$expand === void 0 ? void 0 : _exportConfig$expand.length) exportConfig.expand.forEach(reference => {
    ...
    static _getStream(exportType) {
            ...
            return exportType === 'json' ? JSONStream.stringify('[\n', ',\n', '\n]') : JSONStream.stringify(false);
        }
